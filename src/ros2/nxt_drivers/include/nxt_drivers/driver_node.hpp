...
class DriverNode : public rclcpp::Node
{
   ...
   private:
    ...
    static constexpr std::array<Port, 4> SENSOR_PORTS = {Port::PORT_1, Port::PORT_2, Port::PORT_3,
                                                         Port::PORT_4};

    static constexpr std::array<Port, 3> MOTOR_PORTS = {Port::PORT_A, Port::PORT_B, Port::PORT_C};
};
